import { isBlank } from "./Str";
import { i18n } from "../Core/_Core";
import { locales } from "../Const/_Const";
  ...
  return pattern.replace(/([a-z])\1*/gi, function(matchStr, group1) {
    ...
    switch (group1) {
      ...
      case DATE_PATTERNS.DAY_OF_WEEK: //E
        replacement = i18n.text(
          locales.E_Text_Key["date_week_" + date.getDay()]
        );
        break;
      ...
      case DATE_PATTERNS.AM_PM: //a
        replacement =
          date.getHours() < 12
            ? i18n.text(locales.E_Text_Key.date_am)
            : i18n.text(locales.E_Text_Key.date_pm);
        break;
